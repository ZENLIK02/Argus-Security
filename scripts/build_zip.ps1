...
try {
  ...
  $rootFiles = @(
    ...
    "options.html", "options.js", "offscreen.html", "offscreen.js", "style.css", "trusted_domains.json", "risky_categories.json",
  ...
  foreach ($file in @("main.py", "reputation.py", "reputation_seed.json", "requirements.txt", "README_BACKEND.md")) {
