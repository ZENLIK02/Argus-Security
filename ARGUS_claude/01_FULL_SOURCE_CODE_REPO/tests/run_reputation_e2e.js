...
async function main() {
  ...
  try {
    ...
    const settings = { useReputation: true, reputationEndpoint: ENDPOINT };
    ...
    const deadSettings = { useReputation: true, reputationEndpoint: "http://127.0.0.1:8799/v1/reputation/check" };
