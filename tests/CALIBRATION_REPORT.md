...
> Historical baseline: ARGUS 5.3 uses `RISKY_CONTEXT` for unverified gambling and early impersonation cautions. References below to gambling remaining SAFE describe the 4.2 engine score, not the current visible evidence-first policy.
